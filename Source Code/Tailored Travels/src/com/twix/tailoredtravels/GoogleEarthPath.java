...
public class GoogleEarthPath {
	...
	/**
	 * Initiates a new Google Earth path to be translated into KML given a
	 * sorted ArrayList<Waypoint> as returned by DistCalcDriver
	 * 
	 * preconditions: sortedList is actually sorted to be a shortest path list
	 * of all waypoints
	 * 
	 * @param _start
	 *            The beginning Waypoint
	...
	/**
	 * getPath returns the linkedList of waypoints for use in creating KML file
	 * 
	 * @return wPath
	 */
